...
document.addEventListener("DOMContentLoaded", function () {
  var regex = /(delete)|(--)|(;)|(drop)|(insert)/; //evitar la insercion de elementos no permitidos

  var tex_ = document.getElementById("tex_");
  var boton = document.getElementById("jj");
  var receta = document.getElementById("flexCheckDefault");
  var p = document.getElementById("p");
  var formulario = document.getElementById("formulario");
  tex_.addEventListener("blur", function (e) {
    //al insertar el tratamiento habilita el boton de enviar 
  ...
  receta.addEventListener("click", function () {
    // si esta actiba, por defecto si, nos lleva a la pagina de donde podremos seleccionar medicinias y dosis, si no directamente guarda la cita con el tratamiento
