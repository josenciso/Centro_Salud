...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var tex_ = document.getElementById("tex_");
  var enviar = document.getElementById("enviar");
  var unidades = document.getElementById("unidades");
  var horas = document.getElementById("horas");
  var datos;
  var tbody = document.getElementById("tbody");
  var url = "https://cima.aemps.es/cima/rest/medicamentos?nombre="; // pagina para la busqueda de medicamentos

  var boton = document.getElementById("boton");
  var medicamento = document.getElementById("medicamento");
  var receta = document.getElementById("med"); //validando las casillas

  tex_.className = "ok";
  tex_.addEventListener("blur", function (e) {
    var reg = regex.test(tex_.value.toLowerCase());
    ...
    if (reg) {
      ...
      tex_.className = "ok"; // boton.removeAttribute("disabled","");
    }
  });
  ...
  medicamento.addEventListener("click", function () {
    //si pulsamos busqueda de medicamentos, debe de estar escrito, realiza la busqueda y devuelve un maximo de 10 objetos 
        ...
        if (conexion.readyState == 4 && conexion.status == 200) {
          (function () {
            ...
            for (i = 0; i < longitud; i++) {
              //se pintan en forma de tabla y si se selecciona con el raton, nos lleva al foco del medicamento. 
              ...
              td.appendChild(img);
              img.setAttribute("src", datos['resultados'][i].fotos[0].url); //document.getElementsByTagName(img).src='\"'+datos['resultados'][i].fotos[0].url+'\"';
  ...
  var verifica = document.getElementById("form"); //con todos los campos verdes, se activa para poder enviar, donde se inserta en historial y se borra de citas
