...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    dateClick: function dateClick($e) {
      ...
      console.log(formatDate(date)); // console.log($e.dateStr);
  ...
  $("#btnagregar").click(function () {
    var datos = datos_del_formulario();
  ...
  function restablecer_horas() {
    ...
    $('#h5').removeAttr('disabled'); //$('#h1').attr('enabled', 'enabled'); /PTE ADAPTAR MAS HORAS
  }
});