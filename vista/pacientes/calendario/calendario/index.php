...
<body>
  ...
  <div class="container-fluid">
    ...
    <section id="services" class="services">
      ...
      <a id="v" class="text-white" href="../../portal_pacientes.php">Volver </a>
        <div class="section-title">
          <h2 class="text-white">CITAS PACIENTES</h2>
          <p></p>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-lg-8 " id='calendar'></div>
      ...
      $paciente_cita = $_POST['citar']; //viene de paciente
      $nombre =$_SESSION['paciente1']; 
          ...
          <div class="modal-dialog" role="document">
            ...
            <small id="helpId" class="text-muted">Help text</small>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <div class="input-group input-group-lg ">
                      <span class="bg-info background-color-info text-center  col-12" id="inputGroup-sizing-lg">
                        <h3>PACIENTE</h3>
                      </span>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="input-group input-group-lg">
                        <!--CAMPO DNI-->
                        <input type="text" name="title" id="fk_paciente" value="<?php echo $_SESSION['paciente0'] ?>" class="form-control text-center" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" hidden="true">
              ...
              <div class="form-row">
                <!--FECHAS Y HORAS-->
                <div class="input-group input-group-lg">
                  <span class="input-group-text bg-primary" id="inputGroup-sizing-lg">FECHA</span>
                  <input type="text" name="fecha" id="fecha_cita" class="form-control text-center" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                </div>

                <div class="form-group col-md-6" id="TituloHoraInicio">
                  <label>Seleccion de hora disponibles:</label>
                  ...
                  <div name="title" id="date_click" value="" class="date_click form-control text-center" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                    ...
                    while ($fila1 = mysqli_fetch_row($resultado_01)) {
                      $hora = $fila1[3]; //dni
                      //$nombre =  $fila[3];//nombre
                      $cita_calendario = $fila1[4]; //calle


                      //$fk_medico =$fila[6];//fk,medico
                      //$edad = $FILA[7];//FECHA
                      array_push($cajon, [$cita_calendario, $hora]);
                      /// echo $hora;echo ' '.$cita_calendario; 
                    }
                    ...
                    <input type="text" id="contador" value="<?php echo $contador ?> " hidden>
                      ...
                      <select class="" name="hora" id="hora">Seleccione hora
